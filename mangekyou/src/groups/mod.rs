...
use crate::error::{MangekyouError, MangekyouResult};
...
pub trait GroupElement:
    ...
    + Div<Self::ScalarType, Output = Result<Self, MangekyouError>>
...
pub trait FromTrustedByteArray<const LENGTH: usize>: Sized {
    fn from_trusted_byte_array(bytes: &[u8; LENGTH]) -> MangekyouResult<Self>;
}
